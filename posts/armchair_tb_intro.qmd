...
-   [Introducing TB Mortality Number per 100,000 People](/posts/armchair_tb_mortality.html)

## Data:

-   [Connect to the World Bank DataBank using R](/posts/connect_world_bank_data_bank.html)

-   [Connect to Global Health Observatory (WHO) Data API with R](/posts/connect/armchair_tb_who_data.html)
